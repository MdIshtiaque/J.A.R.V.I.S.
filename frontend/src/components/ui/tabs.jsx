...
const TabsList = React.forwardRef(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 items-center justify-center rounded-lg bg-muted/60 p-1 text-muted-foreground backdrop-blur-md border border-white/5",
      className
    )}
    {...props}
  />
